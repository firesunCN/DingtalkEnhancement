        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            show_icon.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object isChecked) {
                    ...
                    packageManager.setComponentEnabledSetting(new ComponentName(getActivity(), "me.firesun.dingtalk.enhancement.SettingsActivity_Alias"), status, PackageManager.DONT_KILL_APP);
                    return true;
                }
            });
            ...
            repair.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference pref) {
                    ...
                    if (context != null) {
                        SharedPreferences.Editor editor = context.getSharedPreferences(HookParams.DINGTALK_ENHANCEMENT_CONFIG_NAME, Context.MODE_WORLD_READABLE).edit();
                        editor.clear();
                        editor.commit();
                ...
                public boolean onPreferenceClick(Preference pref) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                PackageInfo packageInfo = packageManager.getPackageInfo(HookParams.DINGTALK_PACKAGE_NAME, 0);
                                String dingtalkApk = packageInfo.applicationInfo.sourceDir;
                                PathClassLoader dtClassLoader = new PathClassLoader(dingtalkApk, ClassLoader.getSystemClassLoader());
                                SearchClasses.generateConfig(dingtalkApk, dtClassLoader, packageInfo.versionName);
