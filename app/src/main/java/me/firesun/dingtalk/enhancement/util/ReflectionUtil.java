...
public final class ReflectionUtil {
    ...
    public static void log(String msg) {
        ...
        Log.i("Xposed", "[DingtalkEnhancement] " + msg);
    }
    ...
    public static Method findMethodsByExactParameters(Class clazz, Class returnType, Class... parameterTypes) {
        ...
        if (list.isEmpty())
            ...
            for (int i = 0; i < list.size(); i++) {
                log(String.format("methods %d: %s", i, list.get(i).toString()));
            }
        }
    ...
    public static Classes findClassesFromPackage(ClassLoader loader, List<String> classes, String packageName, int depth) {
        ...
        for (int i = 0; i < classes.size(); i++) {
            ...
            if (clazz.lastIndexOf(".") >= 0) {
                currentPackage = clazz.substring(0, clazz.lastIndexOf("."));
            }
    ...
    public static final class Classes {
        ...
        public final Classes filterByMethod(Class<?> cls, Class<?>... clsArr) {
            ...
            for (Object next : this.classes) {
                try {
                    ...
                    log(String.format("%s getDeclaredMethods error!", next.toString()));
                }
        ...
        public final Classes filterBySuperClass(Class superClass) {
            List arrayList = new ArrayList();
        ...
        public final Classes filterByMethod(Class returnType, int parameterSize) {
            List arrayList = new ArrayList();
            for (Class next : this.classes) {
                ...
                for (Method method : methods) {
                    ...
                    if (returnType.equals(method.getReturnType()) && classes.length == parameterSize) {
                        arrayList.add(next);
                        break;
                    }
                }
        ...
        public final Class<?> firstOrNull() {
            if (this.classes.isEmpty())
                ...
                for (int i = 0; i < this.classes.size(); i++) {
                    log(String.format("class %d: %s", i, this.classes.get(i).toString()));
                }
            }
